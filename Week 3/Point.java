    ...
    public Comparator<Point> slopeOrder() {
        return new Comparator<Point>() {
            ...
            public int compare(Point that, Point other) {
                if (that == null || other == null) throw new NullPointerException();
                double firstSlope = slopeTo(that);
                double secondSlope = slopeTo(other);
                ...
                else return Double.compare(firstSlope, secondSlope);
            }
        /* YOUR CODE HERE */
        };
    }
